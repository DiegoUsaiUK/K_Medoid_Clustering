...
I got hold of this dataset in the course of a recruitment selection process as I was asked to carry out an analysis and present results and recommendations that could __helps improve their product sign up__ in my final meeting. Although fictitious in nature, I thought it best to __further anonimise the dataset__ by changing names and values of most of the variables as well as removing several features that were of no use to the analysis
...
From experience I found that a very good exercise is to print out (on screen or paper) summaries of each single cluster - here's an example for __cluster 2__.  Lay all the summaries before you and let your __inner Sherlock Holmes__ comes out to play! The story usually unfolds before your very eyes when you start comparing the differences between clusters.
...
__RECOMMENDATION 1__: there may be potential to __incentivise Credit Card payments__ as they seem to associate with higher Subscription Rate
...
__RECOMMENDATION 2__: there may be potential to investigate __different price points__ for Premium product that could help boost take up

__RECOMMENDATION 3__: acquisition campaigns should be __more closely aligned to a single product__ to ensure accountability and better understanding of acquisition dynamics
...
* __Investigate different price points for premium product__ - Lower price point could boost take up
